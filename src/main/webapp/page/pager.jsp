...
<script type="text/javascript" src="<c:url value='/static/js/jquery-1.4.1.min.js'/>"></script>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/static/page/pager.css"/>
...
<c:choose>
    ...
    <span>页</span>
    <a href="javascript:_go();" class="aBtn">确定</a>
  </div>
</div>