...
<html>
  ...
  <body>
    ...
    <div class="body-all">
        <div class="body-left">
            <span>修改文章</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:18px;">${msg}</span>
            <form id="form" action="${pageContext.request.contextPath }/admin/modify?id=${article.id}" method="post" enctype="multipart/form-data">
                <input id="blogName" type="text" name="title" placeholder="在此输入标题" value="${article.title}"/>
                ...
                <div class="div-textarea">
                    <textarea id="newsEditor" name="newsEditor">${article.content}</textarea>
                    <input id="content" type="hidden" name="content" value=""/>
                </div>
                <div class="div-button">
                    <button type="button" class="button" onclick="submitData();">修改</button>
                </div>
            </form>
        </div>
            ...
            <div class="div-tag">
                ...
                <div class="tag-main">
                    <form action="" method="post">
                        ...
                        <button type="submit" id="tagButton" disabled="disabled">添加</button>
                    </form>
                </div>
